...
class SupervisorDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, traineesSnap) {
        ...
        // If no students, show dashboard with zeros
        ...
        return FutureBuilder<QuerySnapshot>(
          ...
          builder: (context, attSnap) {
            ...
            if (attSnap.connectionState == ConnectionState.done &&
                attSnap.hasData &&
                attSnap.data != null) {
                  ...
                  child: Column(children: [
                    ...
                    if (trainees.isEmpty)
                      ...
                      ...trainees.take(4).map((doc) {
                        ...
                        final hrs =
                            (d['completedHours'] ?? 0).toDouble();
                        final rem =
                            (d['remainingHours'] ?? 280).toDouble();
                        final pct = (hrs + rem) > 0
                    ...
                    children: snap.data!.docs.map((doc) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border(
                                bottom:
                                    BorderSide(color: DS.neutral100))),
                        child: Row(children: [
                          Container(
                            width: 4,
                            height: 40,
  ...
  Widget _dot(Color c, String l) => Row(children: [
        ...
        Text(l,
            style: const TextStyle(fontSize: 11, color: DS.neutral500)),
      ]);
}
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(DS.radiusLG),
          border:
              Border.all(color: _h ? DS.primary200 : DS.neutral200),
