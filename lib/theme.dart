    ...
    return ThemeData(
      ...
      textTheme: const TextTheme(
        displayLarge: TextStyle(
          fontSize: 36, fontWeight: FontWeight.bold, color: DS.neutral900,
        ),
        headlineMedium: TextStyle(
          fontSize: 24, fontWeight: FontWeight.bold, color: DS.neutral900,
        ),
        headlineSmall: TextStyle(
          fontSize: 20, fontWeight: FontWeight.w600, color: DS.neutral800,
        ),
        titleLarge: TextStyle(
          fontSize: 18, fontWeight: FontWeight.w600, color: DS.neutral800,
        ),
        titleMedium: TextStyle(
          fontSize: 16, fontWeight: FontWeight.w600, color: DS.neutral800,
        ),
        bodyLarge: TextStyle(
          fontSize: 16, color: DS.neutral700,
        ),
        bodyMedium: TextStyle(
          fontSize: 14, color: DS.neutral600,
        ),
        bodySmall: TextStyle(
          fontSize: 12, color: DS.neutral500,
        ),
        labelLarge: TextStyle(
          fontSize: 14, fontWeight: FontWeight.w600, color: DS.neutral700,
        ),
        labelSmall: TextStyle(
          fontSize: 10, color: DS.neutral400, letterSpacing: 0.5,
        ),
      ),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      chipTheme: ChipThemeData(
        ...
        selectedColor: DS.primary500,
        labelStyle: const TextStyle(fontSize: 13, fontFamily: 'Calibri', color: DS.neutral300),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(DS.radiusFull),
        ),
        side: BorderSide.none,
      ...
      textTheme: const TextTheme(
        ...
        headlineSmall: TextStyle(
          fontSize: 20, fontWeight: FontWeight.w600, color: Color(0xFFE2E8F0),
        ),
        titleLarge: TextStyle(
          fontSize: 18, fontWeight: FontWeight.w600, color: Color(0xFFE2E8F0),
        ),
        titleMedium: TextStyle(
          fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFFE2E8F0),
        ),
        bodyLarge: TextStyle(
          fontSize: 16, color: Color(0xFFCBD5E1),
        ),
        bodyMedium: TextStyle(
          fontSize: 14, color: DS.neutral400,
        ),
        bodySmall: TextStyle(
          fontSize: 12, color: DS.neutral500,
        ),
        labelLarge: TextStyle(
          fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFFCBD5E1),
        ),
        labelSmall: TextStyle(
          fontSize: 10, color: DS.neutral500, letterSpacing: 0.5,
        ),
      ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(icon, size: 48, color: scheme.primary.withOpacity(0.5)),
            ),
...
class ThemedScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color pageBg = overridePageBgColor ??
        (isDark ? DS.darkBg : DS.neutral50);
